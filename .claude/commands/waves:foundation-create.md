...
1. Read schema from `ai_files/schemas/product_foundation_schema.json`
...
This command does NOT use subagents. All steps are executed directly by the main agent to preserve full context from the feasibility and ensure consistent cross-referencing between sections.
