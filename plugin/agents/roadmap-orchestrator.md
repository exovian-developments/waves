...
description: Use this agent when the user needs to create a new product roadmap, update an existing roadmap, transition phases, record decisions, or restructure milestones. Handles both creation and update analysis for product-level strategic planning.
